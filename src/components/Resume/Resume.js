...
import pdf from '../../Assets/Balaji_SDE_Resume.pdf'
      ...
      <Container>
        ...
        <Row className="resume">
          ...
          <Col md={6} className="resume-right">
            ...
            <Resumecontent
              title="Computer Science and Engineering [V.I.T] "
              date="2021 - 2025"
              content={[
                `CGPA: 8.5/10 `,
                'I was complete my bachelor degree fron Vellore Institute of Technology.',
              ]}
            />
